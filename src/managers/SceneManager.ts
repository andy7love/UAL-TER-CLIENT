...
export class SceneManager {
	...
	public createScene(engine: BABYLON.Engine) : BABYLON.Scene {
		...
		skyboxMaterial.reflectionTexture = new BABYLON.CubeTexture("resources/night", scene);
		...
		if (engine.getCaps().s3tc) {
			groundMaterial.diffuseTexture = new BABYLON.Texture("resources/grass.dds", scene);
		} else {
